  ...
  return (
    <section className="relative rounded-[2.5rem] overflow-hidden bg-muted my-12 animate-fade-in">
        ...
        <div className="flex flex-col justify-center space-y-6 md:space-y-8">
          <div className="space-y-4 md:space-y-6">
            ...
            <p className="text-muted-foreground text-lg md:text-xl leading-relaxed max-w-xl animate-slide-up stagger-1">
              欢迎来到我的个人博客，这里是记录思考、分享见解、探索技术与生活的空间。
              在这里，我会分享我的学习心得、技术探索和生活感悟。
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-6 pt-4 animate-slide-up stagger-2">
            <Button 
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-8 py-4 md:px-10 md:py-6 text-base font-medium transition-all hover:scale-105 w-full sm:w-auto flex items-center gap-2"
            >
      ...
      {showWechat && (
        ...
        >
          <div 
            className="bg-card rounded-2xl p-6 max-w-sm w-full shadow-xl animate-scale-in"
